 ...
 *
 * Kurser som bara finns i ett av systemen står inte här, och inte heller de
 * rader där en källa skriver flera kurser mot en ämnesnivå: Helsingborg lägger
 * både Datorteknik 1a och 1b mot Dator- och kommunikationsteknik nivå 1, och
 * samma kurskod (`MATMAT00S`) mot två olika specialiseringar. Ett par är ett
 * par, inte ett av två möjliga svar, så de raderna får ingen motsvarighet.
 *
 * Källor: Komvux Örebros prövningstabell hösten 2026
 * (gymnasieskolor.orebro.se, läst 2026-09-10) och Helsingborgs stads
 * jämförelsetabell mellan gamla kurser och Gy25-ämnesnivåer
 * (media.helsingborg.se, läst 2026-09-12). De två källorna säger samma sak om
 * varje par de båda skriver ut — inget par nedan behövde väljas mellan dem.
 */
...
export const COURSE_PAIRS: CoursePair[] = [
  ...
  // Ur Helsingborgs jämförelsetabell (2026-09-12). Den skriver ut par som
  // Örebros tabell inte tar upp — bland dem Fysik 1a mot Fysik nivå 1b, som
  // inte går att gissa ur vare sig namnet eller koden.
