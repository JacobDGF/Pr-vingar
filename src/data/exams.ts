...
const TIPS_BIOLOGI = [
  'Repetera cellbiologi, genetik och evolution — de tre delar nästan varje prov vilar på.',
  'Rita egna figurer över processer som fotosyntes och celldelning i stället för att läsa om dem.',
  'Öva på att tolka diagram och experimentbeskrivningar, inte bara på att minnas begrepp.',
  'Gamla nationella prov i biologi visar hur mycket resonemang som krävs utöver faktakunskap.',
];
...
const COMPONENTS_BIOLOGI: ExamComponent[] = [
  {
    name: 'Skriftligt prov',
    duration: '2–3 timmar',
    description: 'Cellbiologi, genetik, ekologi och evolution enligt kursens centrala innehåll.',
  },
];

const TIPS_HISTORIA = [
  'Bygg en egen tidslinje över kursens epoker — kronologin bär resten av kunskapen.',
  'Träna källkritik på riktiga källor: vem skrev, när, varför och för vem.',
  'Öva på att förklara orsak och verkan i flera led, det är där de högre betygen ligger.',
  'Koppla historiska skeenden till nutiden — frågorna ber ofta om just den bryggan.',
];
...
const COMPONENTS_HISTORIA: ExamComponent[] = [
  {
    name: 'Skriftligt prov',
    duration: '2,5–3 timmar',
    description: 'Epoker, historiebruk och källkritik enligt ämnesplanen.',
  },
];

const TIPS_RELIGION = [
  'Lär dig världsreligionernas grunddrag sida vid sida i stället för en religion i taget.',
  'Repetera etiska modeller (pliktetik, konsekvensetik, dygdetik) och hur de skiljer sig åt.',
  'Öva på att analysera ett konkret livsfrågedilemma med flera perspektiv.',
  'Träna på att skilja beskrivning från värdering i dina svar — det bedöms.',
];
...
const COMPONENTS_RELIGION: ExamComponent[] = [
  {
    name: 'Skriftligt prov',
    duration: '2–3 timmar',
    description: 'Världsreligioner, etik och livsfrågor enligt ämnesplanen.',
  },
];

const TIPS_FORETAGSEKONOMI = [
  'Räkna igenom resultat- och balansräkning tills strukturen sitter utan mall.',
  'Lär dig kalkylerna (bidrag, påläggs- och nollpunkt) genom att göra tal, inte läsa dem.',
  'Repetera företagsformer, marknadsföring och affärsidé — de återkommer i resonemangsfrågor.',
  'Använd ett verkligt företag som exempel när du övar, det gör svaren konkreta.',
];
...
const COMPONENTS_FORETAGSEKONOMI: ExamComponent[] = [
  {
    name: 'Skriftligt prov',
    duration: '2–3 timmar',
    description: 'Affärsidé, marknadsföring, kalkylering och redovisning enligt ämnesplanen.',
  },
];

const TIPS_IDROTT = [
  'Läs på om träningslära, kost och ergonomi — teoridelen är hälften av bedömningen.',
  'Kom i tid och ombytt: det praktiska momentet bedöms från första minuten.',
  'Repetera hur du planerar och utvärderar ett eget träningsprogram.',
  'Fråga läraren i förväg vilka moment som ingår, upplägget varierar mellan skolor.',
];

const COMPONENTS_IDROTT: ExamComponent[] = [
  {
    name: 'Praktiskt moment',
    duration: 'Varierar',
    description: 'Rörelse, träningslära och friluftsliv bedöms på plats.',
  },
  {
    name: 'Teoridel',
    duration: '1–2 timmar',
    description: 'Hälsa, kost, ergonomi och planering av egen träning.',
  },
];

const TIPS_PROGRAMMERING = [
  'Skriv kod varje dag i språket kursen använder — läsning ensam räcker inte till provet.',
  'Repetera grunderna ordentligt: variabler, villkor, loopar, funktioner och listor.',
  'Öva på att felsöka någon annans kod, det är en egen färdighet som ofta prövas.',
  'Kunna förklara din lösning i ord — den muntliga delen frågar varför, inte bara hur.',
];

const COMPONENTS_PROGRAMMERING: ExamComponent[] = [
  {
    name: 'Praktiskt prov vid dator',
    duration: '3–4 timmar',
    description: 'Lösa programmeringsuppgifter enligt kursens centrala innehåll.',
  },
  {
    name: 'Muntlig genomgång',
    duration: '15–20 min',
    description: 'Förklara din kod, dina val och hur du felsökt.',
  },
];

const TIPS_SVA = [
  'Träna på att skriva utredande text med källhänvisning — det är provets tyngsta del.',
  'Läs svenska nyhetstexter dagligen och skriv ned ord du fastnar på.',
  'Öva den muntliga delen högt, gärna inspelat, tills du hör din egen meningsbyggnad.',
  'Repetera skillnaden mellan talspråk och skriftspråk, den bedöms uttryckligen.',
];

const COMPONENTS_SVA: ExamComponent[] = [
  {
    name: 'Skriftlig uppgift',
    duration: '3 timmar',
    description: 'Utredande eller argumenterande text med källhänvisning.',
  },
  {
    name: 'Muntlig framställning',
    duration: '10–15 min',
    description: 'Förberedd presentation och samtal på svenska.',
  },
];
...
/**
 * Göteborgssvepet 2026-08-28: hela Prövningsenhetens katalog i Alvis, kurs för
 * kurs.
 *
 * Göteborg låg tidigare på fyra listningar som alla sa samma sak — "anmälan
 * öppnar 1 juli" — trots att Alvis publicerar varje enskilt prövningstillfälle
 * med datum, klockslag, sal och sista anmälningsdag. Fyra vaga kort där det
 * fanns tjugofem exakta är den sortens lucka appen finns för att stänga, så
 * varje kurs nedan bär sitt eget nästa bokningsbara tillfälle, läst ur
 * kurssidan i katalogen.
 */
const GBG_VERIFIED = '2026-08-28';

/**
 * Linvux publicerar ett eget "Ansök här"-formulär per prövningsperiod, och
 * period 3 hösten 2026 är den som är öppen nu. Perioden, avgiften och
 * formuläret är identiska för varje kurs Linvux prövar, så de står en gång
 * här i stället för tjugoen gånger nedan.
 */
const LINVUX_PERIOD_3 = 'Prövningsperiod 3, hösten 2026';

const LINVUX_PERIOD_3_FORM =
  'https://docs.google.com/forms/d/e/1FAIpQLSfda-AcrB_X1CQkm87v60SmosDyMSZ7REcNwEca3yqAqpeX6Q/viewform';

const LINVUX_PRICE_NOTE =
  '500 kr per kurs, kostnadsfritt vid tidigare betyg F/IG i kursen (betygsutdrag krävs)';

const GBG_PRICE_NOTE =
  'Avgiften betalas senast fyra veckor före provdatum och återbetalas inte om du lämnar ' +
  'återbud eller uteblir. Avgiftsfritt om du har betyget F i kursen och samtidigt läser ' +
  'något annat inom komvux.';
...
export const EXAMS: Exam[] = [
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 29 september 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 1 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut. Prövningsenheten har även 20 oktober 2026 utlagt i katalogen.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 13 oktober 2026 kl. 17:30–22:00 på Burgårdens gymnasium. Anmälan i Alvis stänger 15 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 29 september 2026 kl. 09:00–12:00 på Burgårdens gymnasium. Anmälan i Alvis stänger 1 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
      applicationEnd: '2026-09-01',
      examWindowStart: '2026-09-29',
      examWindowEnd: '2026-09-29',
      confirmed: true,
  ...
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning torsdag 8 oktober 2026 kl. 17:30–22:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 10 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
  ...
  },
  {
    ...
    // Läst 2026-08-28: under rubriken "Prövningsperioder" står nu en enda
    // mening — "Prövningsperioden för 2026 är fullbokad." Anmälningsfönstret
    // 17–31 augusti låg kvar i datan och hade lyst grönt i tre dagar till,
    // vilket är precis det fall `full` finns för: datumen säger ja, anordnaren
    // säger nej, och anordnaren har rätt.
    nextPeriod: {
      label:
        'Västerås skriver på sin egen sida att prövningsperioden för 2026 är fullbokad. ' +
        'Anmälan gällde vecka 41–44 och stänger 31 augusti — nästa möjlighet är 2027 års ' +
        'period, som publiceras i kurskatalogen.',
      applicationStart: '2026-08-17',
    ...
    components: COMPONENTS_FLERA,
    studyTips: TIPS_FLERA,
    // The kommun page's own "Kurskatalog Vuxenutbildningscentrum" link now
    // 404s (vasteras.alvis.se/provning/amnesomrade → /StatusCode/404): the
    // prövningskategorin is gone from the catalogue while the 2026 period is
    // full, and the catalogue's 879 remaining courses contain no prövning at
    // all. There is no live booking page to point at, so we say that instead
    // of sending someone to a dead one — the override below is what keeps this
    // out of the bare-`page` list the dataset test holds empty.
    registration: {
      kind: 'page',
      ctaLabel: 'Läs på kommunens sida',
      landing:
        'Länken går till Västerås stads egen prövningssida. Anmälan görs i kurskatalogen, men prövningskategorin ligger nere så länge 2026 års period är fullbokad.',
      steps: [
        'Läs villkoren och kontakten på kommunens sida',
        'Vänta tills 2027 års prövningsperiod läggs ut i kurskatalogen',
        'Anmäl dig där och bifoga kvitto på betald avgift (500 kr via Swish, högst två ämnen)',
      ],
    },
    registrationUrl:
    ...
    infoUrl:
      'https://www.vasteras.se/barn-och-utbildning/vuxenutbildning/nivatest-och-provning-infor-vuxenutbildning.html',
    description:
      'Västerås stad samordnar prövning i sfi, grundläggande och gymnasiala kurser hos flera anordnare (ABF, Astar, Hermods, JENSEN, KUI, Nercia, NTI m.fl.). Anmälan görs i kurskatalogen med kvitto på betald avgift, högst två ämnen per period.',
  ...
  },
  {
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 1b bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-1c',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 1c',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 1c bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-2c',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 2c',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 2c bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-3b',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 3b',
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 29 september 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 1 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut. Prövningsenheten har även 19 oktober 2026 utlagt i katalogen.',
      applicationEnd: '2026-09-01',
      examWindowStart: '2026-09-29',
      examWindowEnd: '2026-09-29',
      confirmed: true,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 3b bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-3c',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 3c',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 3c bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-4',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 4',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 4 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-matematik-5',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Matematik',
    course: 'Matematik 5',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Matematik 5 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['matematik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska',
    course: 'Svenska 1',
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 6 oktober 2026 kl. 17:30–22:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 8 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-2',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska',
    course: 'Svenska 2',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-3',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska',
    course: 'Svenska 3',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska 3 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-som-andrasprak-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk 1',
    ...
    components: COMPONENTS_SVA,
    studyTips: TIPS_SVA,
    registrationUrl: 'https://provningsenheten.alvis.se/hittakurser/kurs/12542',
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska som andraspråk 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska-som-andrasprak', 'goteborg', 'gy11'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-som-andrasprak-2',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska som andraspråk',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska som andraspråk 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska-som-andrasprak', 'goteborg', 'gy11'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-svenska-som-andrasprak-3',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk 3',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Svenska som andraspråk 3 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['svenska-som-andrasprak', 'goteborg', 'gy11'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-engelska-5',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Engelska',
    course: 'Engelska 5',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Engelska 5 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['engelska', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-biologi-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Biologi',
    course: 'Biologi 1',
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 6 oktober 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 8 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
      applicationEnd: '2026-09-08',
      examWindowStart: '2026-10-06',
      examWindowEnd: '2026-10-06',
      confirmed: true,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Biologi 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['biologi', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-biologi-2',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Biologi',
    course: 'Biologi 2',
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 3 november 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 6 oktober 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Biologi 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['biologi', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning tisdag 6 oktober 2026 kl. 09:00–12:00 på Burgårdens gymnasium. Anmälan i Alvis stänger 8 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
      applicationEnd: '2026-09-08',
      examWindowStart: '2026-10-06',
      examWindowEnd: '2026-10-06',
      confirmed: true,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Kemi 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['kemi', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    ...
    nextPeriod: {
      label:
        'Prövning torsdag 8 oktober 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 10 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
      applicationEnd: '2026-09-10',
      examWindowStart: '2026-10-08',
      examWindowEnd: '2026-10-08',
      confirmed: true,
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Fysik 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['fysik', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-naturkunskap-niva-1b',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Naturkunskap',
    ...
    nextPeriod: {
      label:
        'Prövning torsdag 15 oktober 2026 kl. 17:30–21:30 på Burgårdens gymnasium. Anmälan i Alvis stänger 17 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Naturkunskap Nivå 1b bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['naturkunskap', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-naturkunskap-niva-2',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Naturkunskap',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Naturkunskap Nivå 2 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['naturkunskap', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-samhallskunskap-niva-1b',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Samhällskunskap',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Samhällskunskap Nivå 1b bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['samhallskunskap', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-historia-niva-1b',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Historia',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Historia Nivå 1b bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['historia', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-psykologi-niva-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    subject: 'Psykologi',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Psykologi Nivå 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['psykologi', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-religionskunskap-niva-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Religionskunskap Nivå 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['religionskunskap', 'goteborg', 'gy25'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-foretagsekonomi-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Företagsekonomi 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['foretagsekonomi', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'goteborg-idrott-och-halsa-1',
    schoolName: 'Prövningsenheten Göteborg',
    provider: 'Göteborgs Stad',
    ...
    nextPeriod: {
      label:
        'Prövning torsdag 1 oktober 2026 kl. 16:00–18:00 på Burgårdens gymnasium. Anmälan i Alvis stänger 3 september 2026, och tillfället har begränsat antal platser — anmälan stänger tidigare om de tar slut.',
    ...
    infoUrl: 'https://goteborg.se/wps/portal/enheter/provningsenheten',
    description:
      'Prövningsenheten samordnar betygsprövning för hela Göteborgs Stad. Idrott och hälsa 1 bokas per provdatum i Alvis, och provet skrivs på Burgårdens gymnasium vid Skånegatan.',
    tags: ['idrott-och-halsa', 'goteborg'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-1b',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 1b',
    ...
    lng: 15.6214,
    price: 500,
    priceNote: LINVUX_PRICE_NOTE,
    nextPeriod: {
      label: LINVUX_PERIOD_3,
      applicationStart: '2026-08-10',
      applicationEnd: '2026-09-04',
      examWindowStart: '2026-09-28',
      examWindowEnd: '2026-10-11',
    ...
    components: COMPONENTS_MATEMATIK,
    studyTips: TIPS_MATEMATIK,
    registrationUrl: LINVUX_PERIOD_3_FORM,
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 1b under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-1c',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 1c',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 1c under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-2b',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 2b',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 2b under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-2c',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 2c',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 2c under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-4',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 4',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 4 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-matematik-5',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Matematik',
    course: 'Matematik 5',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Matematik 5 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['matematik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Svenska 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['svenska', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-svenska-2',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Svenska 2 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['svenska', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Svenska 3 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['svenska', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-svenska-som-andrasprak-1',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk 1',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Svenska som andraspråk 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['svenska-som-andrasprak', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-svenska-som-andrasprak-3',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Svenska som andraspråk',
    course: 'Svenska som andraspråk 3',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Svenska som andraspråk 3 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['svenska-som-andrasprak', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-engelska-5',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Engelska',
    course: 'Engelska 5',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Engelska 5 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['engelska', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-engelska-7',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Engelska',
    course: 'Engelska 7',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Engelska 7 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['engelska', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Kemi 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['kemi', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-fysik-1a',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Fysik 1a under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['fysik', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-biologi-1',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Biologi 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['biologi', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-naturkunskap-1b',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Naturkunskap',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Naturkunskap 1b under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['naturkunskap', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-samhallskunskap-1b',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Samhällskunskap',
    course: 'Samhällskunskap 1b',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Samhällskunskap 1b under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['samhallskunskap', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-psykologi-1',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Psykologi',
    course: 'Psykologi 1',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Psykologi 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['psykologi', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-religionskunskap-1',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    subject: 'Religionskunskap',
    ...
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Religionskunskap 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['religionskunskap', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
  {
    id: 'linvux-programmering-1',
    schoolName: 'Linvux (Linköpings vuxenutbildning)',
    provider: 'Linköpings kommun',
    ...
    components: COMPONENTS_PROGRAMMERING,
    studyTips: TIPS_PROGRAMMERING,
    registrationUrl: LINVUX_PERIOD_3_FORM,
    infoUrl:
      'https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser',
    description:
      'Linvux prövar Programmering 1 under prövningsperiod 3 hösten 2026, med skrivdagar vecka 40–41 på Kunskapsgallerian i Linköping. Du kan söka högst tre kurser per period, och antalet platser är begränsat.',
    tags: ['programmering', 'linkoping', 'östergötland'],
    verifiedAt: GBG_VERIFIED,
  },
];
